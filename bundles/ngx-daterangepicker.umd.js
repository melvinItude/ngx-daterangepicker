(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('date-fns'), require('date-fns/locale/es'), require('date-fns/locale/en'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-daterangepicker', ['exports', '@angular/core', '@angular/forms', 'date-fns', 'date-fns/locale/es', 'date-fns/locale/en', '@angular/common'], factory) :
    (global = global || self, factory(global['ngx-daterangepicker'] = {}, global.ng.core, global.ng.forms, global.dateFns, global.es, global.en, global.ng.common));
}(this, function (exports, core, forms, dateFns, es, en, common) { 'use strict';
    ...
    var NgxDateRangePickerComponent = /** @class */ (function () {
        ...
        NgxDateRangePickerComponent.propDecorators = {
            fromInput: [{ type: core.ViewChild, args: ['fromInput', { static: true },] }],
...
//# sourceMappingURL=ngx-daterangepicker.umd.js.map
